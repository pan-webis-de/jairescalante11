...
import libsvm.kernel.Chi2Kernel;
import libsvm.kernel.SpecialKernel;
...
abstract class Kernel extends QMatrix {
	...
	double kernel_function(int i, int j) {
		...
		case svm_parameter.SpecialKernel:
			SpecialKernel kernel = new Chi2Kernel();
			return kernel.calculateKernel(x[i], x[j]);
		default:
			return 0; // java
		}
	}
	...
	static double k_function(svm_node[] x, svm_node[] y, svm_parameter param) {
		...
		case svm_parameter.SpecialKernel:
			SpecialKernel kernel = new Chi2Kernel();
			return kernel.calculateKernel(x, y);
		default:
			return 0; // java
		}
	}
...
public class svm {
	...
	public static String svm_check_parameter(svm_problem prob,
		...
		if (kernel_type != svm_parameter.LINEAR
				...
				&& kernel_type != svm_parameter.SpecialKernel)
